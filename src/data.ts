...
export const products: Product[] = [
  ...
  {
    slug: "colgante-zen",
    name: "products.colgante-zen.name",
    category: "complementos",
    price: 14,
    currency: "€",
    short: "products.colgante-zen.short",
    description: [
      "products.colgante-zen.description.0",
      "products.colgante-zen.description.1",
    ],
    details: [
      { label: "products.colgante-zen.details.0.label", value: "products.colgante-zen.details.0.value" },
      { label: "products.colgante-zen.details.1.label", value: "products.colgante-zen.details.1.value" },
      { label: "products.colgante-zen.details.2.label", value: "products.colgante-zen.details.2.value" },
    ],
    image: "media/product-colgante-zen.webp",
  },
  {
    slug: "pendientes-zen",
    name: "products.pendientes-zen.name",
    category: "complementos",
    price: 12,
    currency: "€",
    short: "products.pendientes-zen.short",
    description: [
      "products.pendientes-zen.description.0",
      "products.pendientes-zen.description.1",
    ],
    details: [
      { label: "products.pendientes-zen.details.0.label", value: "products.pendientes-zen.details.0.value" },
      { label: "products.pendientes-zen.details.1.label", value: "products.pendientes-zen.details.1.value" },
      { label: "products.pendientes-zen.details.2.label", value: "products.pendientes-zen.details.2.value" },
    ],
    image: "media/product-pendientes-zen.webp",
  },
  {
    slug: "anillo-zen",
    name: "products.anillo-zen.name",
    category: "complementos",
    price: 10,
    currency: "€",
    short: "products.anillo-zen.short",
    description: [
      "products.anillo-zen.description.0",
      "products.anillo-zen.description.1",
    ],
    details: [
      { label: "products.anillo-zen.details.0.label", value: "products.anillo-zen.details.0.value" },
      { label: "products.anillo-zen.details.1.label", value: "products.anillo-zen.details.1.value" },
      { label: "products.anillo-zen.details.2.label", value: "products.anillo-zen.details.2.value" },
    ],
    image: "media/product-anillo-zen.webp",
  },
  {
